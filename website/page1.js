       ...
       var tmp1=1 ;
        ...
        $("#basic1").click(function(){
         ...
         $("#res").mouseover(function(){
            $("#res").css("color","green").css("background","#FFFFFF") ;
             $(".a").css("color","green").css("background","#ADEBAD") ;
         });
         ...
         $("#lec").mouseover(function(){
            $("#lec").css("color","green").css("background","#FFFFFF") ;
             $(".b").css("color","green").css("background","#ADEBAD") ;
         });
         ...
         $("#contact").mouseover(function(){
            $("#contact").css("color","green").css("background","white") ;
             $(".e").css("color","green").css("background","#ADEBAD") ;
         });
         ...
         $("#about").mouseover(function(){
            $("#about").css("color","green").css("background","white") ;
             $(".d").css("color","green").css("background","#ADEBAD") ;
         });
         ...
         $("#quiz").mouseover(function(){
            $("#quiz").css("color","green").css("background","white") ;
             $(".c").css("color","green").css("background","#ADEBAD") ;
         });
